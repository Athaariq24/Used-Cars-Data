...
def load_csv_to_postgres():
    ...
    df = pd.read_csv('/opt/airflow/dags/P2M3_Thariq_data_raw.csv')
...
def ambil_data():
    ...
    df.to_csv('/opt/airflow/dags/P2M3_Thariq_data_raw_new.csv', sep=',', index=False)
...
def preprocessing(): 
    ...
    '''
    # pembisihan data
    data = pd.read_csv("/opt/airflow/dags/P2M3_Thariq_data_raw_new.csv")
    ...
    data.to_csv('/opt/airflow/dags/P2M3_Thariq_data_raw_clean.csv', index=False)
    
def upload_to_elasticsearch():
    es = Elasticsearch("http://elasticsearch:9200")
    df = pd.read_csv('/opt/airflow/dags/P2M3_Thariq_data_raw_clean.csv')
...
with DAG(
    "P2M3_Thariq_DAG_hck", #atur sesuai nama project kalian
